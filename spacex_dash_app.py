...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        data_gr=data['class'].value_counts().reset_index()
        figg=px.pie(data_gr,values='count', 
        names='class', 
        title='Total success Launch for '+ entered_site)
        return figg
# TASK 4:
...
def get_scatter_chart(entered_site, payload_range):
    ...
    if entered_site == 'ALL':
        ...
        figg1 = px.scatter(data1, x='Payload Mass (kg)', y='class',
        color='Booster Version Category', 
